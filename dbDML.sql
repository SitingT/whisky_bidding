...
(5, 'Credit Card', 'Online', 'Payment via credit card', TRUE),
(6, 'PayPal', 'Online', 'Payment via PayPal account', TRUE),
(7, 'Bank Transfer', 'Offline', 'Payment via direct bank transfer', TRUE),
...
(5, 1, 2, 120.00, '2024-03-10 11:00:00'),
(6, 2, 3, 160.00, '2024-03-11 13:00:00'),
(7, 1, 4, 130.00, '2024-03-10 12:00:00'),
(8, 2, 1, 170.00, '2024-03-11 14:00:00');
...
(5, 1, 2, 1, 220.00, 'Completed', 'Completed', 1, '1Z12345E0291980793', '2024-03-17 11:00:00'),
(6, 2, 3, 2, 320.00, 'Completed', 'Completed', 2, '1Z12345E0291980794', '2024-03-18 13:00:00'),
(7, 3, 4, 3, 170.00, 'Cancelled', 'Failed', 3, '1Z12345E0291980795', '2024-03-16 10:00:00'),
(8, 4, 5, 4, 420.00, 'Initiated', 'Pending', 4, '1Z12345E0291980796', '2024-03-15 16:00:00');
...
(5, 2, 1, 1, 4.5, 'Great whisky, smooth and rich flavor.', '2024-03-17 12:00:00', FALSE),
(6, 3, 2, 2, 4.7, 'Excellent bourbon, exceeded my expectations.', '2024-03-18 14:00:00', FALSE),
(7, 4, 3, 3, 3.8, 'Good whisky, but not as exceptional as advertised.', '2024-03-16 11:00:00', FALSE),
(8, 5, 4, 4, 4.2, 'Very nice Irish whiskey, smooth with a light finish.', '2024-03-15 17:00:00', FALSE);
...
(5, 1, 2, 'Hey, are you interested in the Scotch whisky I listed?', '2024-03-10 14:00:00', FALSE, 1),
(6, 2, 3, 'Can you provide more details about the bourbon whiskey?', '2024-03-11 15:30:00', FALSE, 2),
(7, 3, 1, 'I have a question about the Japanese whisky auction.', '2024-03-12 16:45:00', FALSE, 3),
(8, 4, 2, 'Is the Irish whiskey still available for purchase?', '2024-03-13 17:30:00', FALSE, 4);

INSERT INTO ForumPosts (PostID, AuthorID, Content, PostTime, IsDeleted) VALUES 
(1, 8, 'What is everyone''s favorite whisky for a special occasion?', '2023-03-08 12:00:00', false),
(2, 7, 'Has anyone tried pairing whisky with non-traditional foods? Curious about your experiments!', '2023-03-09 15:30:00', false),
(3, 6, 'I am new to whisky collecting. Can anyone recommend resources for beginners?', '2023-03-10 09:45:00', false),
(4, 5, 'Upcoming whisky tasting events? Let''s share and possibly meet up!', '2023-03-11 18:20:00', false),
(5, 4, 'What is your favorite whisky and why?', '2024-03-10 14:00:00', FALSE),
(6, 3, 'Has anyone tried Japanese whisky? Thoughts?', '2024-03-11 15:30:00', FALSE),
(7, 2, 'Best whisky for a beginner?', '2024-03-12 16:45:00', FALSE),
(8, 1, 'How do you properly store whisky?', '2024-03-13 17:30:00', FALSE);
...
(5, 8, 3, 'Spam', 'User is sending unsolicited messages.', '2024-03-10 14:00:00'),
(6, 5, 1, 'Harassment', 'User is making inappropriate comments.', '2024-03-11 15:30:00'),
(7, 7, 2, 'Fraud', 'User is posting misleading information about a product.', '2024-03-12 16:45:00'),
(8, 6, 4, 'Inappropriate Content', 'User is sharing offensive content in their posts.', '2024-03-13 17:30:00');
...
(5, 6, 2, '2024-03-10 14:00:00'),
(6, 8, 3, '2024-03-11 15:30:00'),
(7, 5, 4, '2024-03-12 16:45:00'),
(8, 7, 1, '2024-03-13 17:30:00');
...
(2, 2, 3, 'Bank wire transfer confirmation #23456', '2023-03-21 15:30:00'),
(3, 3, 4, 'Cash payment received in person', '2023-03-22 09:45:00'),
(4, 4, 4, 'Check payment #78910 received', '2023-03-23 16:20:00'),
(5, 1, 3, 'Bank transfer confirmation number: 123456789', '2024-03-17 12:00:00'),
(6, 2, 3, 'Bank transfer confirmation number: 987654321', '2024-03-18 14:00:00'),
(7, 3, 4, 'Cash payment received by seller', '2024-03-16 11:00:00'),
(8, 4, 4, 'Cash payment received by seller', '2024-03-15 17:00:00');
